...
@log
def expr_two_pcs_vs_rs(n_max, nth, ns, rflct, grid_divides, qcb_approx=True):
...
def write_data_to_file(df, n_max, nth, ns, rflct, grid_divides, cols):
    filename = "../output/data/expr_2_pcs_nmax_{:d}_nth_{}_div_{}_{}.csv"\
...
if __name__ == "__main__":
    ...
    expr_two_pcs_vs_rs(n_max=32, nth=1.0, ns=0.01, rflct=0.01, grid_divides=3, qcb_approx=True)
